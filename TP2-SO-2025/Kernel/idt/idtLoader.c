...
void load_idt(void) {
	...
	setup_IDT_entry(0x08, (uint64_t)&_exceptionHandler08, kernel_cs);
	setup_IDT_entry(0x0D, (uint64_t)&_exceptionHandler0D, kernel_cs);
	setup_IDT_entry(0x0E, (uint64_t)&_exceptionHandler0E, kernel_cs);
